...
REM
REM Generated by Vivado on Sat Jul 19 18:56:22 +0530 2025
...
echo "xvlog --incr --relax -prj blu_zed_tb_vlog.prj"
call xvlog  --incr --relax -prj blu_zed_tb_vlog.prj -log xvlog.log
